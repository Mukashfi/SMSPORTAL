...
import { SubUsersComponent } from 'app/entities/sub-users/sub-users.component';
...
describe('Component Tests', () => {
  describe('SubUsers Management Component', () => {
    let comp: SubUsersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SubUsersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.subUsers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
