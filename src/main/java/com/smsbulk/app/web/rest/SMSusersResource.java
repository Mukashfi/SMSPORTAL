...
public class SMSusersResource {
    ...
    public SMSusersResource(SMSusersRepository sMSusersRepository) {
    ...
    public List<SMSusers> getAllSMSusers() {
        log.debug("REST request to get all SMSusers");
        return sMSusersRepository.findAll();
    }
