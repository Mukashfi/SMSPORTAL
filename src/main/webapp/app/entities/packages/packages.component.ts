...
export class PackagesComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.packagesService
      ...
      .subscribe(
        (res: HttpResponse<IPackages[]>) => this.paginatePackages(res.body, res.headers),
  ...
  trackId(index: number, item: IPackages) {
    return item.id;
  }
  ...
  protected paginatePackages(data: IPackages[], headers: HttpHeaders) {
